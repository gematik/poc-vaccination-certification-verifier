...
# Description (short): Performs use case PKI_20_createEE.
#        For more information see
#        a. ../README.sh and
#        b. CmdLine.ACTION_PKI_ENTITY
# Usage: ./PKI_30_createEE.sh commonName CA
