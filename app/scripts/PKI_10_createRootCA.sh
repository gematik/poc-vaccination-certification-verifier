...
# Description (short): Performs use case UC_10_createRootCA.
#        For more information see
#        a. ../README.sh and
#        b. CmdLine.ACTION_PKI_ROOT_CA
# Usage: ./PKI_10_createRootCA.sh commonName
...
ACTION="--PKI-CreateRootCA"

# --- check command line parameter
if [ ! 1 -eq $# ]; then
  echo "  ERROR: one parameter shall be present: commonName"
