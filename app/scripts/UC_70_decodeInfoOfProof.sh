...
# Description (short): Performs use case UC_70_decodeInfoOfProof.
#        For more information see
#        a. ../README.sh and
#        b. CmdLine.ACTION_INFOPROOF_DECODE
# Usage: ./UC_60_verifySignature.sh prefix
...
if [ ! 1 -eq $# ]; then
  echo "  ERROR: one parameter shall be present: prefix of file to be processed"
  echo "         Usage: $0 prefix"
  exit 12
fi # end if
