...
# Description (short): Performs use case PKI_32_createCompactCertificate.
#        For more information see
#        a. ../README.sh and
#        b. CmdLine.ACTION_PKI_COMPACT
# Usage: ./PKI_32_createCompactCertificate.sh commonNameSubject commonNameIssuer
...
ACTION="--PKI-CreateCompact"

# --- check command line parameter
if [ ! 2 -eq $# ]; then
  echo "  ERROR: two parameters shall be present: commonName CA"
  echo "         Usage: $0 commonName CA"
  exit 12
fi # end if
